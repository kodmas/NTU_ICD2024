...
`elsif APR
    `define SDFFILE "./layout/IOTDF_apr.sdf"
`endif
...
`ifdef SYN
    `ifdef F2
        $fsdbDumpfile("IOTDF_F2_syn.fsdb");
    `else
        $fsdbDumpfile("IOTDF_F1_syn.fsdb");
    `endif

`elsif APR
   `ifdef F2
        $fsdbDumpfile("IOTDF_F2_apr.fsdb");
    `else
        $fsdbDumpfile("IOTDF_F1_apr.fsdb");
    `endif
`else
    `ifdef F2
